...
date: "2024-10-23"
excerpt: "A curious application of binary search."
coverImage: "/blog/negative-binary-search/cover.png"
categories: ["DS&A"]
---

One of the points we touch on on the upcoming book, [Beyond Cracking the Coding Interview](https://www.amazon.com/dp/195570600X), is that binary search has many interesting applications besides finding an element in a sorted array. I'll share an example based on a personal story that's a bit too niche for the book, but kind of fun.
