...
date: "2026-06-18"
excerpt: "A proxy that turns a Claude Code session's context into editable frames - delete, compact, offload, and reorder what the model sees."
...
Recently, new patterns are emerging to give more control:[^soft-handoff][^semi-compact]
...
[^semi-compact]: One dev's ["semi-compact"](https://x.com/greg_horvay/status/2072302254481121550) leaves the last ~40K tokens alone and only compacts what's older.
...
_Want to leave a comment? You can post under the [linkedin post](https://www.linkedin.com/posts/nilmamano_day-67-of-building-agentic-tooling-until-activity-7473462691135692800-5IK1) or the [X post](https://x.com/Nil053/status/2067697243772313890)._
