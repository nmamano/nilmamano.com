...
If you can see the context behind the UI -- see through the illusion -- you'll have a good grasp of how AI apps are built. (This is what led me to build [Context Composer](/blog/context-composer), a Claude Code proxy that shows you the raw context sent each turn, and even lets you edit it directly.)
