...
That said, Claude's SVG capabilities are a lot more spiky than coding. It sometimes fails and thrashes at trivial tasks, like moving the window a few pixels over. It's like if Claude sometimes got wrong the Fizz Buzz test.
...
Things like autocomplete on slash commands or an embedded terminal start to matter a lot.
