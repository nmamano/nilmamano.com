...
The main friction with running multiple agents in parallel was terminal management; I had a mix of local and remote sessions (tasks like [model training](/blog/wall-game-ai) can only be done remotely) and was ssh'ing all the time.

[Tmux](https://github.com/tmux/tmux/wiki) and [cmux](https://cmux.com/) helped. But what actually did it for me was:

1. Building a browser-based, multi-provider agent management system.
...
That was the starting premise. Since then, I've been rethinking agent management; I think features like [agent-to-agent communication](#agent-to-agent-communication) and human collaboration at the agent-chat level will soon become standard.

### Office metaphor

But my tool, [Isomux](https://isomux.com) (Isometric Multiplexer), has something extra: it's cute.
...
Try [the demo](https://isomux.com/demo) and see if it clicks.
...
The source is on [github.com/nmamano/isomux](https://github.com/nmamano/isomux).
...
- the model, permission mode, thinking effort, etc.
...
### Agent identity with hierarchical prompts
