...
In this post I describe how I built [isomux.com](https://isomux.com) ([github](https://github.com/nmamano/isomux)) and my takeaways on designing meta-harnesses. I describe independently-developed features like [agent-collaboration skills](#applications), [human collaboration at the agent-chat level](#human-collaboration) via mixed human-agent message queues, a [REST-API-for-UI architecture](#giving-agents-superpowers), [hierarchical system prompts](#hierarchical-prompts) and [memory](#hierarchical-memory), and [non-linear hand-off systems](#shared-task-board).
...
<Callout>
  ...
  [onboard non-technical people into meta-harnesses](https://x.com/Nil053/status/2047935826366267505).
</Callout>
