...
<BlogImage
  ...
  alt="Two collapsed tool-call rows in the isomux chat: a plain Bash row showing a raw git commit command, and below it an Isomux-tagged row reading 'Save a memory for this agent' with scope and text payload fields shown as chips"
/>
