...
The main friction with consistently running multiple agents in parallel was terminal management; I had a mix of local and remote sessions (tasks like [model training](/blog/wall-game-ai) can only be done remotely) and was ssh'ing all the time.
...
That was the starting premise. Since then, I've added features like agent-to-agent communication and human collaboration at the agent-chat level.
