...
<Problem number={1} title="Max Queue" link="https://bctci.co/max-queue" />
...
<Solution
  number={1}
  title="Max Queue"
  link="https://bctci.co/max-queue-solution"
/>
...
<Problem
  ...
  link="https://bctci.co/sliding-window-max"
/>
...
<Solution
  number={2}
  title="Sliding Window Max"
  link="https://bctci.co/sliding-window-max-solution"
/>
...
tiles = [1, 2, 3]
Output: 4
The mosaic is 3x3, and it looks like: The largest blue rectangle is 2x2 at the bottom right corner.
