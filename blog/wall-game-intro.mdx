...
coverImage: "/blog/wall-game-intro/cover2.png"
categories: ["wallgame"]
---
...
Next, I'll write about [Deep Wallwars](https://github.com/t-troebst/Deep-Wallwars), an alpha-zero-like AI made by a friend, as well as other interesting aspects of the app's implementation, like automatic puzzle generation, or the graph theory concepts behind move validity checking.
