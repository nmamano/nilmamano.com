...
<Callout title='"Why are you building this?"'>
...
- [Training an AlphaZero-style AI](/blog/wall-game-ai) and [a deep dive into its inference pipeline](/blog/wall-game-inference)
