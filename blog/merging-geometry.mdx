...
I'll use gifs to show 3D solids. The gifs show the solid from the front (left) and the back (right). They were made with [this Python app](https://github.com/nmamano/mobiustorus) I vibe coded.
...
This project started from seeing a [tweet](https://x.com/PhysInHistory/status/1892892736048468367) with this gif:
