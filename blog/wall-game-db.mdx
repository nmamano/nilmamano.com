...
date: "2025-05-12"
excerpt: "The specs of the DB for the Wall Game."
coverImage: "/blog/wall-game-db/diagram.png"
categories: ["wallgame"]
---

This blog post documents the initial design for the DB schema for the [Wall Game](https://nilmamano.com/blog/category/wallgame), with commentary on the design choices.
...
The DB is a PostgreSQL database, though I aim to keep the schema as dialect-agnostic as possible in case I want to migrate in the future. (You can see [this post](/blog/2025-stack.mdx) for a discussion on how I chose the tech stack.)
