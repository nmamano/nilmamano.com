...
As of 2025, LLMs can't understand--let alone evaluate--novel computer science research papers. If you ask an LLM to review such a paper, it will output something that _looks_ like one, including a plausible accept/reject verdict based on things mentioned in the paper. However, it will lack any substance.
