...
In this case, the hidden prompt didn't explicitly violate the conference's policies. It was only when they got rejected due to "scientific misconduct" that they realized the prompt was an issue. They hadn't even consulted with their co-authors before adding it, and the co-authors were fine with this after the rejection came in.

Conferences will likely update their policies soon to explicitly ban hidden prompts. ICML [already has](https://icml.cc/Conferences/2025/PublicationEthics).
