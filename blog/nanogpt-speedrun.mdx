...
<Callout title="Main takeaway">
The code is more "recognizable" than I expected for a speedrun. Compared to a textbook implementation, the speedup comes from:

1. An accumulation of small local tweaks, validated by running the benchmark.
2. One genuinely new idea, the Muon optimizer.
</Callout>

_Target audience: engineers who know Python but have never built an LLM (large language model)._
