...
date: "2020-06-22"
excerpt: "A comprehensive guide to different implementations of Dijkstra's algorithm, with code."
coverImage: "/blog/implementing-dijkstra/cover.png"
categories: ["dsa"]
---
...
Usually, we analyze the algorithms _after_ implementing them. However, in order to choose the best data structure for the priority queue, we need to analyze how much we use each type of operation.
