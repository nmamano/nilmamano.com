...
I'm [rebuilding](https://nilmamano.com/blog/wall-game-ui) one of my side projects from scratch, the Wall Game. The first version is playable at [wallwars.net](https://wallwars.net) _(Side note: let me know what name you prefer, WallWars or Wall Game)_.
...
- LLM friendly-ish (popular, but APIs change constantly).
