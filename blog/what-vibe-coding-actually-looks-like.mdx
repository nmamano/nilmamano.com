...
Notice how I don't start by asking for the final state. Part of vibe coding is _chunking_ what you want to do into a series of conceivable steps.
...
> 7. that's almost correct, but there's a weird gap where some of the sides don't touch
...
Here is the thing: people operate in different modes. I wanted these visualizations to satisfy my curiosity, and later to write the blog post, not because I wanted to code. I was in _writer mode_. My goal was to convey information clearly, and vibe coding is a _tool_ that helped me do that.
