...
date: "2020-02-05"
excerpt: "A step-by-step guide to understanding and implementing dynamic programming algorithms with practical examples."
coverImage: "/blog/breaking-down-dynamic-programming/thumbnail.png"
...
We already saw steps 1&ndash;4 with the Fibonacci example. Now, we will walk through all the steps in more detail using a more complicated example, the _longest common subsequence problem_:
...
<BlogImage
  src="/blog/breaking-down-dynamic-programming/lcstable.svg"
  alt="LCS table"
  width="70%"
...
<BlogImage
  src="/blog/breaking-down-dynamic-programming/palindrometable.svg"
  alt="Table for substring count"
  width="70%"
  needsBackground={true}
/>
