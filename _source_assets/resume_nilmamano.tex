...
\vspace{2px}
\noindent\llap{\textbullet\hspace{6pt}}Led a 120-student study on the effect of immediate automated feedback on learning outcomes.
...
\begin{description}
	...
	\noindent\llap{\textbullet\hspace{6pt}}Built an agent orchestration system where conversations are multi-agent, multi-user, multi-provider, and multi-device. (React, Bun, WebSocket, Claude Agent SDK, Codex App Server)

	\vspace{2px}
	\noindent\llap{\textbullet\hspace{6pt}}Isometric office UI with animated agent workers as an intuitive visual metaphor.

	\vspace{2px}
	\noindent\llap{\textbullet\hspace{6pt}}Bun process manages agent lifecycles, inter-agent messaging, and real-time sync across clients via WebSocket.
