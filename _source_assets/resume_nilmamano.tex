...
\begin{description}
	...
	Co-wrote the official sequel to Cracking the Coding Interview with Gayle L. McDowell et al. \#1 Best Seller in Data Structures \& Algorithms on Amazon (\href{https://www.amazon.com/dp/195570600X}{amazon.com/dp/195570600X}).
...
\begin{description}
	...
	A companion DS\&A toolkit for Beyond Cracking the Coding Interview. Built an automated pipeline to parse, test, and generate articles for all 1,440 code solutions across 5 languages. (Next.js, TypeScript, Python)
