...
\begin{description}
	...
	\noindent\llap{\textbullet\hspace{6pt}}Built a meta-harness where conversations are multi-agent, multi-user, multi-provider, and multi-device. (React, Bun, WebSocket, Claude Agent SDK, Codex App Server)
