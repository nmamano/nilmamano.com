...
\begin{description}
	...
	\vspace{2px}
	\noindent\llap{\textbullet\hspace{6pt}}Built and owned the bandwidth allocation and validation components. Designed time-series-based algorithms for distributing the projected available bandwidth among products when demand exceeds capacity, balancing prioritization, fairness, and continuity constraints.
