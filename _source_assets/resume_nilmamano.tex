...
\begin{description}
	...
	\vspace{2px}
	\noindent\llap{\textbullet\hspace{6pt}}Implemented a Negamax-based engine and adapted an AlphaZero-style engine, training a model to superhuman strength via self-play. (C++, PyTorch, TensorRT, ONNX)
