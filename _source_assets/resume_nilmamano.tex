...
\begin{description}
	...
	\noindent\llap{\textbullet\hspace{6pt}}Built an agent orchestration server on a single Bun process, enabling multiple Claude Code agents to be managed and monitored in real-time across devices via WebSocket through a responsive, browser-based UI. (React, Bun, WebSocket, Claude SDK)
