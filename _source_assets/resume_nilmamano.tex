...
\begin{description}
	...
	\vspace{2px}
	\noindent\llap{\textbullet\hspace{6pt}}Built \href{https://dsatoolkit.com}{dsatoolkit.com}, a companion site to practice all the book's problems, with an AI interviewer I co-designed (tens of thousands of interviews, \href{https://bctci.co/ai}{bctci.co/ai}).

	\vspace{2px}
	\noindent\llap{\textbullet\hspace{6pt}}Automated large-scale codebase changes with test-driven LLM loops, e.g., translating 288 book solutions from Python to Go, re-prompting each until its tests passed.
...
\section*{AI Projects}
\begin{description}
	\item[Isomux]\quad \href{https://isomux.com}{isomux.com} \hfill 2026 -- current

	\noindent\llap{\textbullet\hspace{6pt}}Building a meta-harness where multiple Claude and Codex agents and humans can collaborate in the same conversation. (React, Bun, WebSocket, Claude Agent SDK, Codex App Server)

	\vspace{2px}
	\noindent\llap{\textbullet\hspace{6pt}}Isometric office UI with animated agent workers as an intuitive visual metaphor, optimized for desktop and mobile.

	\vspace{2px}
	\noindent\llap{\textbullet\hspace{6pt}}Cron jobs, a shared task board, a built-in editor, terminal, and diff tool, and more, all controllable by the agents via an API.
	...
	\noindent\llap{\textbullet\hspace{6pt}}A full-stack online board game with AIs as first-class citizens through a bot protocol. (React, TypeScript, WebSocket, PostgreSQL)

	\vspace{2px}
	\noindent\llap{\textbullet\hspace{6pt}}Implemented two engines for it: a Negamax-based one and an AlphaZero-style one with models trained via self-play. (C++, PyTorch, TensorRT, ONNX)
