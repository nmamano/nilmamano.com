...
\href{https://scholar.google.bg/citations?hl=en&user=LIuIigEAAAAJ}{scholar.google.bg/citations?user=LIuIigEAAAAJ} $|$ Co-authored 9 peer-reviewed papers on algorithm design, including as main author in tier A conferences like ICALP and ISAAC. The papers describe new algorithmic improvements in graph theory, computational geometry, and computational biology.
...
\href{https://github.com/nmamano/SANA}{github.com/nmamano/SANA} $|$ Created SANA, a C++ biological network alignment tool that uses simulated annealing. 100+ citations; actively maintained for 10+ years by 50+ collaborators, with 2,000+ commits.
\end{description}
