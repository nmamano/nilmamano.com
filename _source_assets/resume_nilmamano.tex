...
\begin{description}
	...
	\vspace{2px}
	\noindent\llap{\textbullet\hspace{6pt}}Built \href{https://dsatoolkit.com}{dsatoolkit.com}, a companion site to practice all the book's problems, each linking to an AI interviewer I co-designed (tens of thousands of interviews).
...
\begin{description}
	...
	\vspace{2px}
	\noindent\llap{\textbullet\hspace{6pt}}Cron jobs, a shared task board, a built-in editor, terminal, diff tool, and more, all controllable by the agents via an API.
	...
	\vspace{2px}
	\noindent\llap{\textbullet\hspace{6pt}}Implemented two engines for it: a Negamax-based one and an AlphaZero-style one with models trained to superhuman strength via self-play. (C++, PyTorch, TensorRT, ONNX)
