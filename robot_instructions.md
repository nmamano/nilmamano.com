...
- **Content**: Long-form blog posts use MDX format (`blog/*.mdx`); short-form feed posts live in `posts/*.md` — see [`docs/feed-posts.md`](docs/feed-posts.md) for that format and how to add one (do not reverse-engineer it from code)
